 ...
 */
@Entity
@Table(name = "tran_reqrsp_offus_25")
public class OFFUSTransaction {
	@Id
	...
	private String accIdentification1;
	@Column(name = "REQ_DE103")
	private String accIdentification2;
	...
	private byte[] isoReq;
	@Transient
	private byte[] cdaRequest;
	@Transient
	private byte[] verifyBAVRequest;
	...
	/**
	 * @return the cdaRequest
	 */
	public byte[] getCdaRequest() {
		return cdaRequest;
	}

	/**
	 * @param cdaRequest the cdaRequest to set
	 */
	public void setCdaRequest(byte[] cdaRequest) {
		this.cdaRequest = cdaRequest;
	}

	/**
	 * @return the verifyBAVRequest
	 */
	public byte[] getVerifyBAVRequest() {
		return verifyBAVRequest;
	}

	/**
	 * @param verifyBAVRequest the verifyBAVRequest to set
	 */
	public void setVerifyBAVRequest(byte[] verifyBAVRequest) {
		this.verifyBAVRequest = verifyBAVRequest;
	}

	/**
	 * @return the accIdentification1
	 */
	public String getAccIdentification1() {
		return accIdentification1;
	}

	/**
	 * @param accIdentification1 the accIdentification1 to set
	 */
	public void setAccIdentification1(String accIdentification1) {
		this.accIdentification1 = accIdentification1;
	}

	/**
	 * @return the accIdentification2
	 */
	public String getAccIdentification2() {
		return accIdentification2;
	}

	/**
	 * @param accIdentification2 the accIdentification2 to set
	 */
	public void setAccIdentification2(String accIdentification2) {
		this.accIdentification2 = accIdentification2;
	}

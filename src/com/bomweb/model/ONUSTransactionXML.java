...
public class ONUSTransactionXML {
	...
	@Column(name = "REQ_accountno")
	private String REQ_accountno;
	...
	@Column(name = "RSP_accountno")
	private String RSP_accountno;
	...
	/**
	 * @return the rEQ_accountno
	 */
	public String getReQ_accountno() {
		return REQ_accountno;
	}

	/**
	 * @param rEQ_accountno
	 *            the rEQ_accountno to set
	 */
	public void setReQ_accountno(String rEQ_accountno) {
		REQ_accountno = rEQ_accountno;
	}
	/**
	...
	/**
	 * @return the rSP_accountno
	 */
	public String getRSP_accountno() {
		return RSP_accountno;
	}

	/**
	 * @param rSP_accountno
	 *            the rSP_accountno to set
	 */
	public void setRSP_accountno(String rSP_accountno) {
		RSP_accountno = rSP_accountno;
	}

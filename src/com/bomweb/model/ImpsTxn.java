 ...
 */
@Entity
@Table(name = "tran_imps_reqrsp")
public class ImpsTxn {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "IMPS_SEQ")
	@SequenceGenerator(name = "IMPS_SEQ", sequenceName = "IMPS_SEQ", allocationSize = 0)
	@Column(name = "LOG_ID")
	private int id;
	...
	@Column(name = "REMITCIFNO")
	private String remitCifNo;
	...
	/**
	 * @return the remitCifNo
	 */
	public String getRemitCifNo() {
		return remitCifNo;
	}

	/**
	 * @param remitCifNo
	 *            the remitCifNo to set
	 */
	public void setRemitCifNo(String remitCifNo) {
		this.remitCifNo = remitCifNo;
	}
	 ...
	 *            the impsReq to set
	 */
	public void setImpsReq(byte[] impsReq) {
		this.impsReq = impsReq;
	}

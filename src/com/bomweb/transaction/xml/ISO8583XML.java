...
public class ISO8583XML {
	...
	public static byte[] createXML(Transaction_IN in) {
		try {
			...
			info.setRefSeq("");
            info.setAccountno(in.getAccountno());
			...
			// addItem.setValue("00100245002003UID04502006001910007109571210415990630020106400201065015CIF_957121041599066015CIF_520867700524");
			...
			File file = new File("E://BOM/Enrollment/txn_req" + in.getRrn() + ".xml");
			if (file.exists())
				file.delete();
			file.createNewFile();

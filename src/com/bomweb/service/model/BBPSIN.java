...
public class BBPSIN {
	 ...
	 *            the reqByte to set
	 */
	public void setReqByte(byte[] reqByte) {
	 ...
	 *            the reqPrvID to set
	 */
	public void setReqPrvID(String reqPrvID) {
		this.reqPrvID = reqPrvID;
	}
	...
	public String getUid_vid() {
		return uid_vid;
	}

	public void setUid_vid(String uid_vid) {
		this.uid_vid = uid_vid;
	}

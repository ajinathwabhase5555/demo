 ...
 *
 */
public class Transactionoffus_IN {
	 ...
	 * @return the txnModes
	 */
	public String getTxnModes() {
		return txnModes;
	}

	/**
	 * @param pan
	 *        txnModes   the txnModes to set
	 */
	public void setTxnModes(String txnModes) {
		this.txnModes = txnModes;
	}
